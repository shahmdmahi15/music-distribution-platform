...
export const clientPasswordUpdateSchema = z
  .object({
    currentPassword: z
...
export type ClientPasswordUpdateInput = z.infer<
  typeof clientPasswordUpdateSchema
>;
export type ClientPasswordUpdateError = z.inferFlattenedErrors<
  typeof clientPasswordUpdateSchema
>;
