...
export default async function WhiteLabelDomainPage() {
  ...
  const defaultDomainConfig = {
    ...
    sslStatus: brandingResult.branding.customDomain ? "ACTIVE" : "NOT_CONFIGURED",
    status: {
      verified: !!brandingResult.branding.customDomain,
      sslStatus: brandingResult.branding.customDomain ? ("ACTIVE" as const) : ("NOT_CONFIGURED" as const),
      dnsStatus: brandingResult.branding.customDomain ? ("CONNECTED" as const) : ("PENDING_SETUP" as const),
    },
  };
