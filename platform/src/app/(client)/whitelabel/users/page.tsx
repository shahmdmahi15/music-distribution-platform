...
import { ClientPortalUsersView } from "@/components/client/whitelabel/client-portal-users-view";
import {
  Card,
  CardContent,
  CardDescription,
...
export default async function WhiteLabelUsersPage() {
  const [usersResult, brandingResult] = await Promise.all([
          ...
          <CardHeader className="text-center pb-4">
            ...
            <CardDescription className="text-xs">
              {brandingResult.message ||
                "You must have an approved WhiteLabel application before viewing portal users."}
            </CardDescription>
          </CardHeader>
